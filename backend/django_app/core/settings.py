"""
Django settings for JurChat project.
"""
...
if os.getenv('DB_NAME') and os.getenv('DB_USER'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'jurchat'),
...
# Redis Cache (fallback to local memory for development)
...
PLAN_LIMITS = {
    'FREE': {
        ...
        'chat_messages_per_document': 20,
    },
    'PREMIUM': {
        'documents_per_month': -1,  # Unlimited
        'ai_tokens_per_month': -1,  # Unlimited
        'chat_messages_per_document': -1,  # Unlimited
    }
}
